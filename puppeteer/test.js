...
(async () => {
    ...
    try{
    await page.goto('https://8081-bbcdbbffbfdfbfbeffacdcaecdfbfcfdee.examlyiopb.examly.io/');
...
(async () => {
    ...
    await page.click('#loginButton');
      ...
      await page.waitForSelector('#tariffAddExpenseBody',{timeout:3000});
...
(async () => {
  ...
  await page.setViewport({
    ...
    await page.waitForSelector('#loginBox',{timeout:3000});
    console.log('TESTCASE:FE_admin_addTariff:success');
  }
   catch(e){
    console.log('TESTCASE:FE_admin_addTariff:failure');
  }finally{
    await page.close();
    await browser.close();
  }
